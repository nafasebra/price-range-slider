...
function Range() {
  ...
  return (
   <div className='my-5 relative'>
      ...
      <input type="range" min="0" max="100" onChange={(e) => setWithSlide(Number(e.target.value))} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer" />
   </div>
  )
}
